...
namespace AudioSwitch.CoreAudioApi
{
    public class AudioEndpointVolumeChannel
    {
        ...
        public float VolumeLevel
        {
            get
            {
                Marshal.ThrowExceptionForHR(audioEndpointVolume.GetChannelVolumeLevel(channel, out float result));
                return result;
            }
            set
            {
        ...
        public float VolumeLevelScalar
        {
            get
            {
                Marshal.ThrowExceptionForHR(audioEndpointVolume.GetChannelVolumeLevelScalar(channel, out float result));
                return result;
            }
            set
            {
